  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-gothic overflow-hidden relative">
      <motion.div 
        ...
        className="absolute -top-1/2 -left-1/2 w-full h-full bg-linear-to-br from-cyan-500/10 to-transparent rounded-full blur-3xl pointer-events-none"
      />
      ...
      <div className="text-center z-10 px-6 max-w-3xl mx-auto">
        ...
        >
          <Button 
            ...
            className="h-14 px-8 text-lg rounded-full bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white shadow-lg shadow-cyan-500/20 border border-white/10 group transition-all duration-300"
          >
            Get Started
